    ...
    <div class="tabcont">
      <div class="headersearch">
        ...
        <div>
          ...
          >
            ...
            <el-option label="正常还款" value="正常还款"></el-option>
            <el-option label="平台垫付" value="平台垫付"></el-option>
          </el-select>
        </div>
        <!--        右边导出-->
        <div>
      ...
      <div class="mytable">
        ...
        >
          ...
          <el-table-column property="payName" label="还款人" align="center"></el-table-column>
        </el-table>
      </div>
      <!--      分页-->
      <div class="block">
...
export default {
  ...
  methods: {
    ...
    /**
     * @name: tableToExcel
     * @description: 这个是将数据转换成excel下载下来
     * @return:
     * @Author: Wang Jun
     */
    tableToExcel() {
